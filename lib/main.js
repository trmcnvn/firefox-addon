...
function updateExistingAddon(uuid, xpiPath, version, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Send request
        const response = yield axios_1.default.put(`https://addons.mozilla.org/api/v4/addons/${uuid}/versions/${version}`, body, {
...
function createNewAddon(xpiPath, version, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Send request
        const response = yield axios_1.default.post('https://addons.mozilla.org/api/v4/addons/', body, {
            headers: Object.assign({}, body.getHeaders(), { Authorization: `JWT ${token}` })
        });
        core.debug(`Response: ${JSON.stringify(response.data)}`);
    });
